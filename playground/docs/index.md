...
features:
  - icon: business
    title: Components
    description: Vue components available in every docs site, from DocMeta and FeatureCards to BrandHero, ImageLightbox and task lists.
    link: /v1/components/
...
Edit anything under `src/theme/` and the preview updates instantly, with no rebuild.
